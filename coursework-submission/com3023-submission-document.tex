...
\sloppy
\noindent
\inputminted[linenos, breaklines]{c}{code/code-p1.c}

\newpage
\inputminted[linenos, breaklines]{c}{code/code-p2.c}

\newpage
\inputminted[linenos, breaklines]{c}{code/code-p3.c}

\newpage
\inputminted[linenos, breaklines]{c}{code/code-p4.c}

\newpage
\inputminted[linenos, breaklines]{c}{code/code-p5.c}

\newpage
\inputminted[linenos, breaklines]{c}{code/code-p6.c}
