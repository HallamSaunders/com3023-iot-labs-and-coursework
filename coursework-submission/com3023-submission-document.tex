...
\begin{figure}[h!]
	\centering
	\includegraphics[width=\textwidth]{screenshots/cooja-screenshot.png}
	\caption{Cooja simulation demonstrating the full output produced.}
	\label{fig:cooja-simulation}
\end{figure}
